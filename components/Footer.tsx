  ...
  return (
    <footer className="bg-textPrimary text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-accent to-success rounded-full blur-3xl"></div>
      </div>
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-white/70 text-lg mb-6 max-w-md">
              Automação inteligente que escala seu negócio. Cresça sem complicação.
            </p>
          ...
          {/* Product Column */}
          <div>
            <h3 className="font-display font-bold text-lg mb-4">Produto</h3>
      ...
      {/* Final CTA Section */}
      <div className="relative bg-gradient-to-r from-primary to-accent py-16">
